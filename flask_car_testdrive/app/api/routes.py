...
# по русской статье раскоментить код в конфиге и композе, создать в папке nginx ключ через vim поменять domain
# вернуть nginx такой какой был, сделать сертификат локально через статью на океане, потом сделать пуш и пул
# убедиться, что работает замочек
# № подключить имаге для автоматического обновления сертификата

# сделать сайт https через скинутую статейку, там тоже через nginx надо решать
