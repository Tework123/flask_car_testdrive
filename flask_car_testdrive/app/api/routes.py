...
# надо бы фавикон настроить, но хз, может потом

# а также проверить все функции сайтика, и получить домен, хотя бы посмотреть какие есть.
# нагрузочное тестирование через библиотеку, наверное в отдельной папке pytest либо вообще отдельно

# надо как то сохранить базу, когда обновляю сайт.
# смысл тестов html, если все равно буду всегда с апи работать для фронта
